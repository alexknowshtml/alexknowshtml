...
|-------|---------|-------------|
| 733 | **[smaug](https://github.com/alexknowshtml/smaug)** | Archive your Twitter/X bookmarks to markdown with AI-powered analysis |
| 159 | **[kuato](https://github.com/alexknowshtml/kuato)** | Recall what you discussed with coding agents — pick up where you left off |
| 63 | **[cord](https://github.com/alexknowshtml/cord)** | Discord to Claude Code bridge — talk to Claude through Discord |
| 54 | **[drawbridge](https://github.com/alexknowshtml/drawbridge)** | Ask Claude to draw flowcharts and diagrams — watch them appear on an Excalidraw canvas |
| 32 | **[api2cli](https://github.com/alexknowshtml/api2cli)** | Audience-aware CLI patterns for Node.js — build CLIs for humans, AI agents, or both |
